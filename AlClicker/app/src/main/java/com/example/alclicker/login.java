...
public class login extends AppCompatActivity {
    ...
    public void runLoginRequest(View view){
        ...
        String url = "http://192.168.1.47/ProjetTransDev/vrai/projet-conception-groupe-4-main/api/RequestLogin.php?login="+LoginView.getText().toString()+"&mdp="+MdpView.getText().toString();
