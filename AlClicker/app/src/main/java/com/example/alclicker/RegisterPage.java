...
public class RegisterPage extends AppCompatActivity {
    ...
    public void runRegisterRequest(View view){
        ...
        String url = "http://192.168.1.47/ProjetTransDev/vrai/projet-conception-groupe-4-main/api/RegisterUser.php?login="+LoginView.getText().toString()+"&mdp="+MdpView.getText().toString()+"&email="+emailView.getText().toString();
